...
document.getElementById("alert-close").addEventListener('click', function() {
    const alert: any = document.getElementsByClassName("alert");
...
document.getElementById("alphatest-btn").addEventListener('click', function () {
    ...
    setTimeout(function() {
        const clear:any = document.getElementsByClassName("popup");
...
document.getElementById("submit-btn").addEventListener('click', function() {
    const username:any = document.getElementById("adminusername");
...
document.getElementById("alert-l3-close").addEventListener('click', function() {
    const removeElement:any = document.getElementById("alert-l3");
